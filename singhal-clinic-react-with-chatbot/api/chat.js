...
export default async function handler(req, res) {
  // Allow this API to be called from a different domain (e.g. a site
  // built on another platform) — needed since the widget won't always
  // live on the same domain as this backend.
